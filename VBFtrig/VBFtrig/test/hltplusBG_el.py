# /users/smaruyam/Run2dev/myRun2/V29 (CMSSW_7_4_0)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/smaruyam/Run2dev/myRun2/V29')
)
...
process.hltPreEle8CaloIdMTrackIdMDiPFJet40DEta3p5MJJ750HTT350PFMETNoMu60 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltSingleEle8EgammaCandidatesWrapper = cms.EDFilter( "HLTEgammaTriggerFilterObjectWrapper",
...
process.hltMu8Ele8EtFilter = cms.EDFilter( "HLTEgammaEtFilter",
    ...
    inputTag = cms.InputTag( "hltSingleEle8EgammaCandidatesWrapper" ),
...
process.hltMu8Ele8CkfTrackCandidateMaker = cms.EDProducer( "CkfTrackCandidateMaker",
...
process.hltMu8Ele8CkfTrackProducer = cms.EDProducer( "TrackProducer",
    src = cms.InputTag( "hltMu8Ele8CkfTrackCandidateMaker" ),
    SimpleMagneticField = cms.string( "" ),
...
process.hltMu8Ele8HLTPixelMatchElectronProducers = cms.EDProducer( "EgammaHLTPixelMatchElectronProducers",
    BSProducer = cms.InputTag( "hltOnlineBeamSpot" ),
    UseGsfTracks = cms.bool( False ),
    TrackProducer = cms.InputTag( "hltMu8Ele8CkfTrackProducer" ),
    GsfTrackProducer = cms.InputTag( "" )
)
process.hltMu8Ele8HLTElectronDetaDphiProducer = cms.EDProducer( "EgammaHLTElectronDetaDphiProducer",
    variablesAtVtx = cms.bool( True ),
    useSCRefs = cms.bool( False ),
    BSProducer = cms.InputTag( "hltOnlineBeamSpot" ),
    electronProducer = cms.InputTag( "hltMu8Ele8HLTPixelMatchElectronProducers" ),
    recoEcalCandidateProducer = cms.InputTag( "" ),
    useTrackProjectionToEcal = cms.bool( False )
)
process.hltElectronOneOEMinusOneOPFilterRegional = cms.EDFilter( "HLTElectronOneOEMinusOneOPFilterRegional",
    doIsolated = cms.bool( True ),
    saveTags = cms.bool( True ),
...
process.hltMu8Ele8CaloIdMTrkIdMDEtaFilter = cms.EDFilter( "HLTElectronGenericFilter",
    doIsolated = cms.bool( True ),
    nonIsoTag = cms.InputTag( "" ),
    L1NonIsoCand = cms.InputTag( "" ),
    ...
    lessThan = cms.bool( True ),
    ncandcut = cms.int32( 1 ),
    isoTag = cms.InputTag( 'hltMu8Ele8HLTElectronDetaDphiProducer','Deta' ),
    candTag = cms.InputTag( "hltElectronOneOEMinusOneOPFilterRegional" ),
    thrTimesPtEE = cms.double( -1.0 ),
    thrOverPtEE = cms.double( -1.0 ),
    thrOverPtEB = cms.double( -1.0 )
)
process.hltMu8Ele8CaloIdMTrkIdMDPhiFilter = cms.EDFilter( "HLTElectronGenericFilter",
    doIsolated = cms.bool( True ),
    nonIsoTag = cms.InputTag( "" ),
    L1NonIsoCand = cms.InputTag( "" ),
    thrTimesPtEB = cms.double( -1.0 ),
    ...
    lessThan = cms.bool( True ),
    ncandcut = cms.int32( 1 ),
    isoTag = cms.InputTag( 'hltMu8Ele8HLTElectronDetaDphiProducer','Dphi' ),
    candTag = cms.InputTag( "hltMu8Ele8CaloIdMTrkIdMDEtaFilter" ),
    thrTimesPtEE = cms.double( -1.0 ),
    thrOverPtEE = cms.double( -1.0 ),
    thrOverPtEB = cms.double( -1.0 )
)
...
process.hltPFMETNoMu60 = cms.EDFilter( "HLTMhtFilter",
    saveTags = cms.bool( True ),
...
process.HLT_Ele8_CaloIdM_TrackIdM_DiPFJet40_DEta3p5_MJJ750_HTT350_PFMETNoMu60_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150ORHTT175ORHTT200 + process.hltPreEle8CaloIdMTrackIdMDiPFJet40DEta3p5MJJ750HTT350PFMETNoMu60 + process.HLTRecoMETSequence + process.hltMET20 + process.HLTHBHENoiseCleanerSequence + process.hltMetClean + process.hltMETClean20 + process.HLTAK4CaloJetsSequence + process.hltMetCleanUsingJetID + process.hltMETCleanUsingJetID20 + process.hltDiCaloJet20MJJ400DEta3p5 + process.HLTSingleEle8CaloIdMTrackIdMSequence + process.HLTAK4PFJetsSequence + process.hltDiPFJet40MJJ750DEta3p5 + process.hltPFHT + process.hltPFHT350 + process.hltPFMETNoMuProducer + process.hltPFMETNoMu60 + process.HLTEndSequence )
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_Ele8_CaloIdM_TrackIdM_DiPFJet40_DEta3p5_MJJ750_HTT350_PFMETNoMu60_v1, process.HLTriggerFinalPath ))
...
process.vbftrig = cms.EDAnalyzer("VBFtrig",
    ...
    leptonPid = cms.untracked.int32(11), # electron
    jetEtaHT = cms.untracked.double(3.0),
    jetPtCut = cms.untracked.double(40),
    dEtaCut = cms.untracked.double(3.5),
    lepPtCut = cms.untracked.double(5),
    tauPtCut = cms.untracked.double(10),
    triggerName1 = cms.untracked.string("HLT_Ele8_CaloIdM_TrackIdM_DiPFJet40_DEta3p5_MJJ750_HTT350_PFMETNoMu60_v1"),
    triggerL1Name = cms.untracked.string("hltL1sL1HTT150ORHTT175ORHTT200"),
    triggerL3LeptonName1 = cms.untracked.string("hltMu8Ele8CaloIdMClusterShapeFilter"),
    triggerL3LeptonName2 = cms.untracked.string("hltMu8Ele8CaloIdMPixelMatchFilter"),
    triggerL3LeptonName3 = cms.untracked.string("hltElectronOneOEMinusOneOPFilterRegional"),
    triggerCaloMETName = cms.untracked.string("hltMET20"),
    triggerCaloMETIDName = cms.untracked.string("hltMETCleanUsingJetID20"),
    triggerHTName = cms.untracked.string("hltPFHT350"), 
    triggerDiJetName = cms.untracked.string("hltDiPFJet40MJJ750DEta3p5"),
    triggerPFMETName = cms.untracked.string("hltPFMETNoMu60")
