# /users/amkalsi/myHLT_VBF/V8 (CMSSW_7_2_1_patch2_HLT1)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/amkalsi/myHLT_VBF/V8')
)
...
process.hltL1sL1SingleMu6MuVBF = cms.EDFilter( "HLTLevel1GTSeed",
...
process.hltPreIsoMu10DiJet40MJJ600Eta3p5HTT200Eta5MET140 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
process.hltL1fL1sMu6L1Filtered0MuVBF = cms.EDFilter( "HLTMuonL1Filter",
    saveTags = cms.bool( False ),
    CSCTFtag = cms.InputTag( "unused" ),
    PreviousCandTag = cms.InputTag( "hltL1sL1SingleMu6MuVBF" ),
...
process.hltL2fL1sMu6L1f0L2Filtered6QMuVBF = cms.EDFilter( "HLTMuonL2PreFilter",
    saveTags = cms.bool( True ),
    MaxDr = cms.double( 9999.0 ),
    CutOnChambers = cms.bool( False ),
    PreviousCandTag = cms.InputTag( "hltL1fL1sMu6L1Filtered0MuVBF" ),
...
process.hltL3fL1sMu6L1f0L2f6QL3Filtered10QMuVBF = cms.EDFilter( "HLTMuonL3PreFilter",
    MaxNormalizedChi2 = cms.double( 20.0 ),
    saveTags = cms.bool( True ),
    PreviousCandTag = cms.InputTag( "hltL2fL1sMu6L1f0L2Filtered6QMuVBF" ),
...
process.hltIter1L3MuonClustersRefRemoval = cms.EDProducer( "HLTTrackClusterRemoverNew",
...
process.hltIter1L3MuonTrackSelectionHighPurity = cms.EDProducer( "SimpleTrackListMerger",
    ShareFrac = cms.double( 0.19 ),
    promoteTrackQuality = cms.bool( True ),
    MinPT = cms.double( 0.05 ),
    copyExtras = cms.untracked.bool( True ),
...
process.hltIter1L3MuonMerged = cms.EDProducer( "SimpleTrackListMerger",
    ShareFrac = cms.double( 0.19 ),
    promoteTrackQuality = cms.bool( True ),
    MinPT = cms.double( 0.05 ),
    copyExtras = cms.untracked.bool( True ),
...
process.hltIter2L3MuonClustersRefRemoval = cms.EDProducer( "HLTTrackClusterRemoverNew",
    doStrip = cms.bool( True ),
    doStripChargeCheck = cms.bool( False ),
...
process.hltIter2L3MuonMerged = cms.EDProducer( "SimpleTrackListMerger",
    ShareFrac = cms.double( 0.19 ),
    promoteTrackQuality = cms.bool( True ),
    MinPT = cms.double( 0.05 ),
    copyExtras = cms.untracked.bool( True ),
...
process.hltL3crIsoL1sMu6L1f0L2f6QL3f10QL3crIsoRhoFiltered0p15IterTrk02MuVBF = cms.EDFilter( "HLTMuonIsoFilter",
    saveTags = cms.bool( True ),
    PreviousCandTag = cms.InputTag( "hltL3fL1sMu6L1f0L2f6QL3Filtered10QMuVBF" ),
    MinN = cms.int32( 1 ),
    IsolatorPSet = cms.PSet(  ),
    CandTag = cms.InputTag( "hltL3MuonCandidates" ),
...
process.hltPFHTEta5 = cms.EDProducer( "HLTHtMhtProducer",
    usePt = cms.bool( True ),
...
process.hltPFHT140Eta5 = cms.EDFilter( "HLTHtMhtFilter",
    saveTags = cms.bool( True ),
    mhtLabels = cms.VInputTag( 'hltPFHTEta5' ),
    meffSlope = cms.vdouble( 1.0 ),
    minMeff = cms.vdouble( 0.0 ),
    minMht = cms.vdouble( 0.0 ),
    htLabels = cms.VInputTag( 'hltPFHTEta5' ),
...
process.HLT_IsoMu10_DiJet40_MJJ_600_Eta3p5_HTT200Eta5_MET140_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleMu6MuVBF + process.hltPreIsoMu10DiJet40MJJ600Eta3p5HTT200Eta5MET140 + process.hltL1fL1sMu6L1Filtered0MuVBF + process.HLTL2muonrecoSequence + process.hltL2fL1sMu6L1f0L2Filtered6QMuVBF + process.HLTL3muonrecoSequence + process.hltL3fL1sMu6L1f0L2f6QL3Filtered10QMuVBF + process.HLTL3muoncaloisorecoSequenceNoBools + process.HLTTrackReconstructionForIsoL3MuonIter02 + process.hltL3crIsoL1sMu6L1f0L2f6QL3f10QL3crIsoRhoFiltered0p15IterTrk02MuVBF + process.HLTRecoMETSequence + process.hltMET80 + process.HLTHBHENoiseCleanerSequence + process.hltMetClean + process.hltMETClean80 + process.HLTAK4CaloJetsSequence + process.hltMetCleanUsingJetID + process.hltMETCleanUsingJetID80 + process.hltDiCaloJet30MJJ500DEta3p0 + process.HLTAK4PFJetsSequence + process.hltPFHTEta5 + process.hltPFHT140Eta5 + process.hltDiPFJet40MJJ600DEta3p5 + process.hltPFMETNoMuProducer + process.hltPFMETNoMu140 + process.HLTEndSequence )
...
process.vbftrig = cms.EDAnalyzer("VBFtrig",
    ...
    triggerName1 = cms.untracked.string("HLT_IsoMu10_DiJet40_MJJ_600_Eta3p5_HTT200Eta5_MET140_v1")
)
