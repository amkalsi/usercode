# /users/smaruyam/Run2dev/myRun2/V21 (CMSSW_7_3_1_HLT1)

import FWCore.ParameterSet.Config as cms

process = cms.Process( "TEST" )

process.load("setup2_cff")

process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/smaruyam/Run2dev/myRun2/V21')
)
...
process.hltL1sL1ETM60ORETM70 = cms.EDFilter( "HLTLevel1GTSeed",
    L1SeedsLogicalExpression = cms.string( "L1_ETM60 OR L1_ETM70" ),
...
process.hltPreIsoMuOpenDiPFJet20DEtaOpenMJJOpenHTTOpenPFMETNoMuOpen = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltMETCleanUsingJetID80 = cms.EDFilter( "HLT1CaloMET",
    saveTags = cms.bool( True ),
    MinPt = cms.double( 80.0 ),
    MinN = cms.int32( 1 ),
    MaxEta = cms.double( -1.0 ),
...
process.hltDiCaloJet30MJJ500DEta3p0 = cms.EDFilter( "HLTCaloJetVBFFilter",
    saveTags = cms.bool( True ),
...
process.hltDiPFJet40MJJ600DEta3p5 = cms.EDFilter( "HLTPFJetVBFFilter",
    saveTags = cms.bool( True ),
...
process.hltPFMETNoMuProducer = cms.EDProducer( "HLTMhtProducer",
    usePt = cms.bool( True ),
...
process.hltPFMETNoMu140 = cms.EDFilter( "HLTMhtFilter",
    saveTags = cms.bool( True ),
    mhtLabels = cms.VInputTag( 'hltPFMETNoMuProducer' ),
...
process.hltL1sL1Mu6HTT150 = cms.EDFilter( "HLTLevel1GTSeed",
    L1SeedsLogicalExpression = cms.string( "L1_Mu6_HTT150" ),
    saveTags = cms.bool( True ),
    L1MuonCollectionTag = cms.InputTag( "hltL1extraParticles" ),
    L1UseL1TriggerObjectMaps = cms.bool( True ),
    L1UseAliasesForSeeding = cms.bool( True ),
...
process.hltL1fL1sSingleMu6L1Filtered0 = cms.EDFilter( "HLTMuonL1Filter",
    saveTags = cms.bool( False ),
    CSCTFtag = cms.InputTag( "unused" ),
    PreviousCandTag = cms.InputTag( "hltL1sL1Mu6HTT150" ),
    MinPt = cms.double( 0.0 ),
    MinN = cms.int32( 0 ),
    MaxEta = cms.double( 2.5 ),
    SelectQualities = cms.vint32(  ),
...
process.hltL2fL1sSingleMu6L1f0L2Filtered0Q = cms.EDFilter( "HLTMuonL2PreFilter",
    saveTags = cms.bool( True ),
    MaxDr = cms.double( 9999.0 ),
    CutOnChambers = cms.bool( False ),
    PreviousCandTag = cms.InputTag( "hltL1fL1sSingleMu6L1Filtered0" ),
    MinPt = cms.double( 0.0 ),
    MinN = cms.int32( 0 ),
    SeedMapTag = cms.InputTag( "hltL2Muons" ),
    MaxEta = cms.double( 2.5 ),
...
process.hltL3fL1sSingleMu6L1f0L2f0QL3Filtered0Q = cms.EDFilter( "HLTMuonL3PreFilter",
    MaxNormalizedChi2 = cms.double( 20.0 ),
    saveTags = cms.bool( True ),
    PreviousCandTag = cms.InputTag( "hltL2fL1sSingleMu6L1f0L2Filtered0Q" ),
    MinNmuonHits = cms.int32( 0 ),
    MinN = cms.int32( 0 ),
    MinTrackPt = cms.double( 0.0 ),
    MaxEta = cms.double( 2.5 ),
...
process.hltMuonGlb10RelTrkIsoFiltered0p4 = cms.EDFilter( "HLTMuonIsoFilter",
    saveTags = cms.bool( True ),
    PreviousCandTag = cms.InputTag( "hltL3fL1sSingleMu6L1f0L2f0QL3Filtered0Q" ),
    MinN = cms.int32( 0 ),
    IsolatorPSet = cms.PSet(  ),
    CandTag = cms.InputTag( "hltL3MuonCandidates" ),
    DepTag = cms.VInputTag( 'hltL3MuonRelTrkIsolationVVL' )
...
process.hltL3MuonCombRelIsolationsIterTrkRegIter02 = cms.EDProducer( "L3MuonCombinedRelativeIsolationProducer",
    printDebug = cms.bool( False ),
    CutsPSet = cms.PSet( 
      ConeSizes = cms.vdouble( 0.3 ),
      ComponentName = cms.string( "SimpleCuts" ),
...
process.hltL3crIsoL1sSingleMu6L1f0L2f0QL3f0QL3crIsoRhoFiltered0p15IterTrk02 = cms.EDFilter( "HLTMuonIsoFilter",
    saveTags = cms.bool( True ),
    PreviousCandTag = cms.InputTag( "hltL3fL1sSingleMu6L1f0L2f0QL3Filtered0Q" ),
    MinN = cms.int32( 0 ),
    IsolatorPSet = cms.PSet(  ),
...
process.hltMETCleanOpen = cms.EDFilter( "HLT1CaloMET",
    saveTags = cms.bool( True ),
    MinPt = cms.double( 0.0 ),
    MinN = cms.int32( 0 ),
    MaxEta = cms.double( -1.0 ),
...
process.hltMETCleanUsingJetIDOpen = cms.EDFilter( "HLT1CaloMET",
    saveTags = cms.bool( True ),
    MinPt = cms.double( 0.0 ),
    MinN = cms.int32( 0 ),
    MaxEta = cms.double( -1.0 ),
...
process.hltDiCaloJet20MJJOpenDEtaOpen = cms.EDFilter( "HLTCaloJetVBFFilter",
    saveTags = cms.bool( True ),
...
process.hltPFHTOpen = cms.EDFilter( "HLTHtMhtFilter",
    saveTags = cms.bool( True ),
...
process.hltPFMETNoMuOpen = cms.EDFilter( "HLTMhtFilter",
    saveTags = cms.bool( True ),
    mhtLabels = cms.VInputTag( 'hltPFMETNoMuProducer' ),
    minMht = cms.vdouble( 0.0 )
)
process.hltDiPFJet20MJJOpenDEtaOpen = cms.EDFilter( "HLTPFJetVBFFilter",
    saveTags = cms.bool( True ),
    minDeltaEta = cms.double( 0.0 ),
    leadingJetOnly = cms.bool( False ),
    maxEta = cms.double( 5.0 ),
...
process.HLTL3muoncaloisorecoSequenceNoBools = cms.Sequence( process.HLTDoFullUnpackingEgammaEcalSequence + process.HLTDoLocalHcalSequence + process.hltTowerMakerForAll + process.hltFixedGridRhoFastjetAllCaloForMuons + process.hltL3CaloMuonCorrectedIsolations )
...
process.HLT_DiPFJet40_DEta3p5_MJJ600_PFMETNoMu140_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ETM60ORETM70 + process.hltPreIsoMuOpenDiPFJet20DEtaOpenMJJOpenHTTOpenPFMETNoMuOpen + process.HLTRecoMETSequence + process.hltMET80 + process.HLTHBHENoiseCleanerSequence + process.hltMetClean + process.hltMETClean80 + process.HLTAK4CaloJetsSequence + process.hltMetCleanUsingJetID + process.hltMETCleanUsingJetID80 + process.hltDiCaloJet30MJJ500DEta3p0 + process.HLTAK4PFJetsSequence + process.hltDiPFJet40MJJ600DEta3p5 + process.hltPFMETNoMuProducer + process.hltPFMETNoMu140 + process.HLTEndSequence )
...
process.HLT_IsoMuOpen_DiPFJet20_DEtaOpen_MJJOpen_HTTOpen_PFMETNoMuOpen_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1Mu6HTT150 + process.hltPreIsoMuOpenDiPFJet20DEtaOpenMJJOpenHTTOpenPFMETNoMuOpen + process.hltL1fL1sSingleMu6L1Filtered0 + process.HLTL2muonrecoSequence + process.hltL2fL1sSingleMu6L1f0L2Filtered0Q + process.HLTL3muonrecoSequence + process.hltL3fL1sSingleMu6L1f0L2f0QL3Filtered0Q + process.HLTL3muontrkisovvlSequence + process.hltMuonGlb10RelTrkIsoFiltered0p4 + process.HLTL3muoncaloisorecoSequenceNoBools + process.HLTTrackReconstructionForIsoL3MuonIter02 + process.hltL3crIsoL1sSingleMu6L1f0L2f0QL3f0QL3crIsoRhoFiltered0p15IterTrk02 + process.HLTRecoMETSequence + process.hltMETOpen + process.HLTHBHENoiseCleanerSequence + process.hltMetClean + process.hltMETCleanOpen + process.HLTAK4CaloJetsSequence + process.hltMetCleanUsingJetID + process.hltMETCleanUsingJetIDOpen + process.hltDiCaloJet20MJJOpenDEtaOpen + process.HLTAK4PFJetsSequence + process.hltPFHT + process.hltPFHTOpen + process.hltPFMETNoMuProducer + process.hltPFMETNoMuOpen + process.hltDiPFJet20MJJOpenDEtaOpen + process.HLTEndSequence )
...
process.source = cms.Source( "PoolSource",
    fileNames = cms.untracked.vstring(
        ...
        'file:/eos/uscms/store/user/lammel/mg5_13tev_chi250_stau125_lsp100/events_5raw.root',
    ),
...
process.genjet = cms.Path(process.genParticlesForJets * process.ak4GenJets)

process.vbftrig = cms.EDAnalyzer("VBFtrig",
    ...
    jetEtaHT = cms.untracked.double(3.0),
    jetPtCut = cms.untracked.double(40),
    dEtaCut = cms.untracked.double(3.5),
    muPtCut = cms.untracked.double(5),
    tauPtCut = cms.untracked.double(10),
    triggerName1 = cms.untracked.string("HLT_IsoMuOpen_DiPFJet20_DEtaOpen_MJJOpen_HTTOpen_PFMETNoMuOpen_v1"),
    triggerL1MuName = cms.untracked.string("hltL1sL1Mu6HTT150"),
    triggerL3MuName = cms.untracked.string("hltL3fL1sSingleMu6L1f0L2f0QL3Filtered0Q"),
    triggerL3VVLIsoMuName = cms.untracked.string("hltMuonGlb10RelTrkIsoFiltered0p4"),
    triggerL3IsoMuName = cms.untracked.string("hltL3crIsoL1sSingleMu6L1f0L2f0QL3f0QL3crIsoRhoFiltered0p15IterTrk02"),
    triggerCaloMETName = cms.untracked.string("hltMETOpen"),
    triggerCaloMETIDName = cms.untracked.string("hltMETCleanUsingJetIDOpen"),
    triggerHTName = cms.untracked.string("hltPFHTOpen"),
    triggerDiJetName = cms.untracked.string("hltDiPFJet20MJJOpenDEtaOpen"),
    triggerPFMETName = cms.untracked.string("hltPFMETNoMuOpen")
)
...
process.out=cms.EndPath(process.vbftrig)
